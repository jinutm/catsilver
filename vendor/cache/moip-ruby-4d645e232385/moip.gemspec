...
Gem::Specification.new do |s|
  ...
  s.files = [".document", ".gitignore", "Gemfile", "Gemfile.lock", "LICENSE", "README.markdown", "Rakefile", "VERSION", "lib/moip.rb", "lib/moip/client.rb", "lib/moip/config.rb", "lib/moip/direct_payment.rb", "moip.gemspec", "spec/moip_spec.rb"]
